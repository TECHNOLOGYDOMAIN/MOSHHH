...
<body style="background-image:url(images/locate.png)">
	<div class="header">
		<ul>
			<li style="float:left;border-right:none"><a href="ulogin.php" class="logo"><img src="images/LOGO.png" width="30px" height="30px"><strong> M.O.S.H. </strong>Medical Online Scheduling Helper</a></li>
			<li><a href="cover.php">Home</a></li>
		</ul>
	</div>
	<form action="locateus.php" method="post">
	<div class="sucontainer" style="background-image:url(images/manager.png)">
		<ul style="background-image:url(images/manager.png)">			
