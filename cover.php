<!DOCTYPE html>
<html>
<body style="background-image:url(images/cover.png)">
<link rel="stylesheet" href="main.css">
			<div class="header">
				<ul>
					<li style="float:left;border-right:none"><a href="cover.php" class="logo"><img src="images/LOGO.png" width="25px" height="25px"><strong> M.O.S.H. </strong>Medical Online Scheduling Helper</a></li>
			...
			<div class="footer">
				<ul style="position:absolute;top:93%;background-color:pink">
