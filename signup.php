...
<div class="header">
				<ul>
					<li style="float:left;border-right:none"><a href="cover.php" class="logo"><img src="images/LOGO.png" width="30px" height="30px"><strong> M.O.S.H. </strong>Medical Online Scheduling Helper</a></li>
